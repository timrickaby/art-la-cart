...
class ALCProductType implements IALCProductType
{	
	private $table_name  = '';
	...
	{	
		...
		if (count($result) == 1) {
			...
			throw new ALCException('Product type does not exist.');
		}
	}
	...
	public function name($p_new_value = NULL): string
	{
		if ($p_new_value === NULL) {
	...
	public function description($p_new_value = NULL): string
	{
		if ($p_new_value === NULL) {
