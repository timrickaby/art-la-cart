...
interface IALCImagePriceOption
{
	public function id();
...
class ALCImagePriceOption extends ___ALCObjectLinkable implements IALCImagePriceOption
{
	private $table_name  = '';
	...
	public function __construct($p_id)
	{
		...
		if (count($result) == 1) {
			...
			throw new ALCException('price option does not exist.');
		}
	}
