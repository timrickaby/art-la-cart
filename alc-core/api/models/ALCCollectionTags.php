...
interface IALCCollectionTags
{
	public function add($p_tag);
}


class ALCCollectionTags extends ___ALCObjectPoolRefinable implements IALCCollectionTags
{
	private $table_name  = '';
	...
	public function __construct(IALCFilter $p_filter = NULL) 
	{
		...
		parent::__construct($this->table_name, 'ALCCollectionTag', $p_filter);
	}
