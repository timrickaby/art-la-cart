...
class ALCClientGroup extends ___ALCObjectLinkable implements IALCClientGroup
{
	private $table_name  = '';
	...
	{	
		...
		if (count($result) == 1) {
			...
			throw new ALCException('Client group does not exist.');
		}
	}
