...
interface IALCOrders
{
	public function add($p_name, $display_name, $description, $group_id, $visible_to_acounts, $visible_to_events, $visible_to_galleries);
}


class ALCOrders extends ___ALCObjectPoolRefinable implements IALCOrders
{	
	private $table_name  = '';
	...
	public function __construct(IALCFilter $filter = NULL)
	{
		...
		parent::__construct($this->table_name, 'ALCOrder', $filter);
	}
