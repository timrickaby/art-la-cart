...
class ALCBasketProducts extends ___ALCObjectPoolRefinable implements IALCBasketProducts
{
	private $table_name  = '';
	...
	public function __construct(IALCFilter $p_filter = NULL)
	{
		...
		parent::__construct($this->table_name, 'ALCBasketProduct', $p_filter);
	}
