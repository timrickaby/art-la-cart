...
interface IALCEmployees
{
	public function add($p_account_id, $p_salutation_id, $p_first_name, $p_middle_name, $p_last_name,
						$p_email, $p_phone_landline, $p_phone_mobile, $p_fax, 
						$p_gender,  $p_dob, $p_address_id);
}


class ALCEmployees extends ___ALCObjectPoolRefinable implements IALCEmployees
{
	private $table_name  = '';
	...
	public function __construct(IALCFilter $p_filter = NULL)
	{
		...
		parent::__construct($this->table_name, 'ALCEmployee', $p_filter);
	}
